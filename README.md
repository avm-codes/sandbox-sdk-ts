...
[![NPM version](<https://img.shields.io/npm/v/sandbox-sdk.svg?label=npm%20(stable)>)](https://npmjs.org/package/sandbox-sdk) ![npm bundle size](https://img.shields.io/bundlephobia/minzip/sandbox-sdk)
...
```sh
npm install git+ssh://git@github.com:stainless-sdks/sandbox-sdk-typescript.git
```

> [!NOTE]
> Once this package is [published to npm](https://www.stainless.com/docs/guides/publish), this will become: `npm install sandbox-sdk`
...
```ts
import SandboxSDK from 'npm:sandbox-sdk';
...
We are keen for your feedback; please open an [issue](https://www.github.com/stainless-sdks/sandbox-sdk-typescript/issues) with questions, bugs, or suggestions.
