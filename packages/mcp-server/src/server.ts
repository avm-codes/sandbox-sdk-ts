...
export { ClientOptions } from '@avmcodes/sandbox-sdk';
...
async function getInstructions() {
  ...
  const response = await fetch(
    readEnv('CODE_MODE_INSTRUCTIONS_URL') ?? 'https://api.stainless.com/api/ai/instructions/sandbox-sdk',
    {
      method: 'GET',
  ...
  if (!response.ok) {
    ...
    instructions = `
      This is the sandbox-sdk MCP server. You will use Code Mode to help the user perform
